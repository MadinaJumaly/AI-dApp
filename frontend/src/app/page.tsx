...
const contractAddress = "0x22144BA40Bf92dC7c5619fAD0fd4898a1878008B";
...
export default function Home() {
  ...
  async function requestAccounts() {
    ...
    setConnectedAccount(`With account: ${allAccounts[0]}`);
    getChainId();
  }
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen space-y-2">
      ...
      <br />
      <button
        className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-1 px-2 rounded my-3"
        onClick={() => withdraw()}>
        Widraw Funds
      </button>
      <br />
      <div>
        <h1 className="text-3xl font-bold">Model List</h1>
        <button
          className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-1 px-2 rounded my-3"
